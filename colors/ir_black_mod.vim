...
hi VertSplit        guifg=#CCCCCC     guibg=#202020     gui=NONE      ctermfg=white    ctermbg=darkgray    cterm=NONE
...
if version >= 700 " Vim 7.x specific colors
  ...
  hi PmenuSel       guifg=#000000     guibg=#cae682     gui=NONE      ctermfg=NONE        ctermbg=white        cterm=NONE
...
hi Conditional      guifg=#6699CC     guibg=NONE        gui=NONE      ctermfg=brown        ctermbg=NONE        cterm=NONE  " if else end
...
hi Statement        guifg=#6699CC     guibg=NONE        gui=NONE      ctermfg=brown   ctermbg=NONE        cterm=NONE

hi Special          guifg=#E18964     guibg=NONE        gui=NONE      ctermfg=cyan       ctermbg=NONE        cterm=NONE
hi Delimiter        guifg=#00A0A0     guibg=NONE        gui=NONE      ctermfg=cyan        ctermbg=NONE        cterm=NONE
hi Operator         guifg=white       guibg=NONE        gui=NONE      ctermfg=brown       ctermbg=NONE        cterm=NONE
...
" == Diff ==
hi DiffAdd term=bold ctermbg=4 ctermfg=white guibg=DarkBlue
hi DiffChange term=bold ctermbg=5 ctermfg=black guibg=DarkMagenta
hi DiffDelete term=bold cterm=bold ctermfg=black ctermbg=6 gui=bold guifg=Blue guibg=DarkCyan


" == Other ==
hi SpellCap term=reverse ctermbg=red ctermfg=black gui=undercurl guisp=Blue
